...
typedef enum
{
	WAIT_EVENT_BUFFER_CLEANUP = PG_WAIT_BUFFER,
	WAIT_EVENT_BUFFER_EXCLUSIVE,
	WAIT_EVENT_BUFFER_SHARED,
...
typedef enum
{
	...
	WAIT_EVENT_COPY_FROM_READ,
	WAIT_EVENT_COPY_TO_WRITE,
